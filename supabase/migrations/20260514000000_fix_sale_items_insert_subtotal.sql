...
-- Fix create_appointment_with_sale to remove subtotal from insert
create or replace function public.create_appointment_with_sale(
  p_client_id bigint,
...
begin
  ...
  loop
    ...
    -- Removed subtotal from insert as it is a generated column
...
-- Fix repair_appointment_financials to remove subtotal from insert
